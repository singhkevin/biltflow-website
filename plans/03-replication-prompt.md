...
> Canonical copy: this mirrors `CLAUDEDESIGNBRIEF-v4-addendum.md` at the project root, which is the actively-maintained version — edit that file, not this one, if this ever needs to change.
